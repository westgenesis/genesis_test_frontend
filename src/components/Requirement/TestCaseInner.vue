      ...
      >
        <a-row :gutter="16">
          ...
          >
            <a-button
              type="dashed"
              @click="addPreConditionItem(index)"
              style="margin-right: 0.5rem"
              >+</a-button
            >
            <a-button type="dashed" @click="removePreConditionItem(index)"
              >-</a-button
            >
          </a-col>
        </a-row>
        ...
        <a-row :gutter="16">
          ...
          >
            <a-button
              ...
              >+</a-button
            >
            <a-button type="dashed" @click="removeActionItem(index)"
              >-</a-button
            >
          </a-col>
        </a-row>
      ...
      >
        <a-row :gutter="16">
          ...
          >
            <a-button
              type="dashed"
              @click="addResultItem(index)"
              style="margin-right: 0.5rem"
              >+</a-button
            >
            <a-button type="dashed" @click="removeResultItem(index)"
              >-</a-button
            >
          </a-col>
        </a-row>
